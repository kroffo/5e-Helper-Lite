...
def character_race():
    ...
    if menu_choice == '1':
        ...
        if race_choice == '1':
            character.set_race(races.d_hill.name)
            character.set_str(races.d_hill.scores[0])
            character.set_dex(races.d_hill.scores[1])
            character.set_con(races.d_hill.scores[2])
            character.set_inte(races.d_hill.scores[3])
            character.set_wis(races.d_hill.scores[4])
            character.set_cha(races.d_hill.scores[5])
            character.set_vision(races.d_hill.vision)
            character.set_size(races.d_hill.size)
            character.set_languages(races.d_hill.languages)
            character.set_speed(races.d_hill.speed)
            character.set_r_traits(races.d_hill.r_traits)
            character.set_subr_traits(races.d_hill.subr_traits)
            character.set_combat_prof(races.d_hill.combat_prof)
            character.set_tool_prof(races.d_hill.tool_prof)
        elif race_choice == '2':
            character.set_race(races.d_mountain.name)
            character.set_str(races.d_mountain.scores[0])
            character.set_dex(races.d_mountain.scores[1])
            character.set_con(races.d_mountain.scores[2])
            character.set_inte(races.d_mountain.scores[3])
            character.set_wis(races.d_mountain.scores[4])
            character.set_cha(races.d_mountain.scores[5])
            character.set_vision(races.d_mountain.vision)
            character.set_size(races.d_mountain.size)
            character.set_languages(races.d_mountain.languages)
            character.set_speed(races.d_mountain.speed)
            character.set_r_traits(races.d_mountain.r_traits)
            character.set_subr_traits(races.d_mountain.subr_traits)
            character.set_combat_prof(races.d_mountain.combat_prof)
            character.set_tool_prof(races.d_mountain.tool_prof)
            # print(character.__dict__) DEBUG
        elif race_choice == '3':
